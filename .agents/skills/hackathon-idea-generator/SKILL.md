...
description: >-
  Generate candidate product or positioning directions when Layak's strategy is explicitly reopened. Do not use for
  ordinary implementation or demo delivery when the product direction is already set.
---
